		...
		<div class="row">
			<div class="col-md">
				<form method='POST' action="/store" enctype="multipart/form-data">
					...
					<script
						src="https://maps.googleapis.com/maps/api/js?language = ja&region = JP&key = AIzaSyB41DRUbKWJHPxaFjMAwdrzWzbVKartNGg&libraries = places&callback = initMap"
						async defer></script>
					...
					<div class="col-5">
						<button type="button" class="btn btn-outline-secondary btn-block"
							onclick="location.href  =  '/home'">レビューやめる</button>
					</div>
					<div class="col-1">
					</div>
					<br>
